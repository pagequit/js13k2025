...
// ZzFXMicro - Zuper Zmall Zound Zynth - v1.3.0 by Frank Force ~ 1000 bytes
// (modified)
...
R;c*=R;y*=500*d/R**3;A*=d/R;v*=d/R;z*=R;l=R*l|0;p*=zzfx.vol;for(h=e+m+r+t+c|0;a<h;k[a++]
...
H++),g+=x+x*E*Z(a**5),n&&++n>z&&(b+=v,C+=v,n=0),!l||++I%l||(b=C,u=G,n=n||1);p=zzfx.ctx.
createBuffer(1,h,R);p.getChannelData(0).set(k);b=zzfx.ctx.createBufferSource();
b.buffer=p;b.connect(zzfx.ctx.destination);b.start()};
